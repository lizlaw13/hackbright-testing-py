...
def is_mel(name, email):
    ...
    name = name.lower()
    email = email.lower()
    return name == "mel melitpolski" or email == "mel@ubermelon.com" or name == "mel" or name == "melitpolski"
...
def most_and_least_common_type(treats):
    ...
    >>> treats = [{'type': 'dessert'},{'type': 'dessert'},{'type': 'dessert'},{'type': 'appetizer'},{'type': 'appetizer'},{'type': 'appetizer'},{'type': 'appetizer'},{'type': 'drink'},]
